...
class OverduePopupActivity : Activity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val overdue = CitrineWidgetUtils.array(data, "overdue")

        val root = LinearLayout(this).apply {
            orientation = LinearLayout.VERTICAL
            setPadding(44, 36, 44, 32)
            setBackgroundColor(CitrineWidgetUtils.bgColor(this@OverduePopupActivity))
        }
        ...
        if (overdue.length() == 0) {
            list.addView(TextView(this).apply {
                ...
                setTextColor(CitrineWidgetUtils.mutedColor(this@OverduePopupActivity))
    ...
    private fun overdueRow(item: org.json.JSONObject): LinearLayout {
        ...
        row.addView(LinearLayout(this).apply {
            ...
            addView(TextView(this@OverduePopupActivity).apply {
                ...
                textSize = 18f
                typeface = android.graphics.Typeface.DEFAULT_BOLD
                setTextColor(CitrineWidgetUtils.textColor(this@OverduePopupActivity))
            })
            addView(TextView(this@OverduePopupActivity).apply {
