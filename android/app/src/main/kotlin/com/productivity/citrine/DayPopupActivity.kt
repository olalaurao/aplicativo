...
class DayPopupActivity : Activity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val data = CitrineWidgetUtils.json(
            HomeWidgetPlugin.getData(this).getString("citrine_calendar", null),
        )
        ...
        val items: org.json.JSONArray = when (mode) {
            "month" -> {
                ...
                val grid = CitrineWidgetUtils.array(data, "monthGrid")
            ...
            "week" -> {
                ...
                CitrineWidgetUtils.array(data, "items")
            }
        }
        ...
        val root = LinearLayout(this).apply {
            ...
            setBackgroundColor(CitrineWidgetUtils.bgColor(this@DayPopupActivity))
        }
        root.addView(TextView(this).apply {
            text = date.ifBlank { "Dia" }
            textSize = 20f
            setTextColor(CitrineWidgetUtils.textColor(this@DayPopupActivity))
        ...
        if (items.length() == 0) {
            list.addView(TextView(this).apply {
                ...
                setTextColor(CitrineWidgetUtils.mutedColor(this@DayPopupActivity))
        ...
        root.addView(TextView(this).apply {
            ...
            textSize = 16f
            gravity = Gravity.CENTER
            setTextColor(CitrineWidgetUtils.accent)
            setPadding(0, 22, 0, 6)
