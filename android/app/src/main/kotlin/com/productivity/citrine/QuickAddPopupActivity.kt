...
class QuickAddPopupActivity : Activity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val root = LinearLayout(this).apply {
            ...
            setBackgroundColor(CitrineWidgetUtils.bgColor(this@QuickAddPopupActivity))
        }
        
        root.addView(TextView(this).apply {
            text = "Nova Tarefa"
            textSize = 20f
            setTextColor(CitrineWidgetUtils.textColor(this@QuickAddPopupActivity))
            typeface = android.graphics.Typeface.DEFAULT_BOLD
        })
        
        editText = EditText(this).apply {
            hint = "Digite a tarefa..."
            setHintTextColor(CitrineWidgetUtils.mutedColor(this@QuickAddPopupActivity))
            setTextColor(CitrineWidgetUtils.textColor(this@QuickAddPopupActivity))
            setBackgroundColor(CitrineWidgetUtils.chipColor(this@QuickAddPopupActivity))
        ...
        val cancelBtn = Button(this).apply {
            text = "Cancelar"
            setTextColor(CitrineWidgetUtils.mutedColor(this@QuickAddPopupActivity))
    ...
    private fun addTask() {
        ...
        if (taskTitle.isNotEmpty()) {
            ...
            intent.data = Uri.parse("citrine://widget-toggle?type=quick_add&title=${Uri.encode(taskTitle)}")
