...
class QuartzoApplication : FlutterApplication() {

    companion object {
        private const val TAG = "QuartzoApplication"
    ...
    // â”€â”€â”€ Native crash handler â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    // â”€â”€â”€ ANR watchdog â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    // â”€â”€â”€ Report writers â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    private fun writeAnrReport(mainThread: Thread) {
        try {
            ...
            val content = buildString {
                ...
                appendLine("---")
                appendLine()
                appendLine("# Crash Report â€” suspected_anr")
                appendLine()
                appendLine("## Context")
    ...
    private fun writeCrashReport(kind: String, throwable: Throwable, thread: Thread) {
        ...
        val content = buildString {
            ...
            appendLine("---")
            appendLine()
            appendLine("# Crash Report â€” $kind")
            appendLine()
            appendLine("## Context")
            appendLine("| Field | Value |")
            appendLine("|---|---|")
