...
class ShoppingAddPopupActivity : Activity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val root = LinearLayout(this).apply {
            ...
            setBackgroundColor(QuartzoWidgetUtils.bgColor(this@ShoppingAddPopupActivity))
        }
        
        root.addView(TextView(this).apply {
            text = "Novo Item"
            textSize = 20f
            setTextColor(QuartzoWidgetUtils.textColor(this@ShoppingAddPopupActivity))
            typeface = android.graphics.Typeface.DEFAULT_BOLD
        })
        
        editText = EditText(this).apply {
            hint = "Digite o item..."
            setHintTextColor(QuartzoWidgetUtils.mutedColor(this@ShoppingAddPopupActivity))
            setTextColor(QuartzoWidgetUtils.textColor(this@ShoppingAddPopupActivity))
            setBackgroundColor(QuartzoWidgetUtils.chipColor(this@ShoppingAddPopupActivity))
        ...
        val cancelBtn = Button(this).apply {
            text = "Cancelar"
            setTextColor(QuartzoWidgetUtils.mutedColor(this@ShoppingAddPopupActivity))
    ...
    private fun addShoppingItem() {
        ...
        if (itemName.isNotEmpty()) {
            ...
            intent.data = Uri.parse("Quartzo://widget-toggle?type=shopping_add&name=${Uri.encode(itemName)}")
