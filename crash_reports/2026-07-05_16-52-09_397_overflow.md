---
type: overflow
created_at: 2026-07-05T16:52:09.397929
...
The specific RenderFlex in question is: RenderFlex#7f48d relayoutBoundary=up6 OVERFLOWING:
  parentData: offset=Offset(32.0, 32.0) (can use size)
  constraints: BoxConstraints(0.0<=w<=274.8, 0.0<=h<=211.3)
  size: Size(274.8, 211.3)
  direction: vertical
