---
type: overflow
created_at: 2026-06-30T11:13:42.748963
...
The specific RenderFlex in question is: RenderFlex#9c9d7 relayoutBoundary=up5 OVERFLOWING:
  parentData: offset=Offset(32.0, 32.0) (can use size)
  constraints: BoxConstraints(0.0<=w<=274.8, 0.0<=h<=173.7)
  size: Size(274.8, 173.7)
  direction: vertical
