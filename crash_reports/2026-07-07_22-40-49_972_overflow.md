---
type: overflow
created_at: 2026-07-07T22:40:49.972435
...
The specific RenderFlex in question is: RenderFlex#6f390 relayoutBoundary=up1 OVERFLOWING:
  parentData: offset=Offset(0.0, 0.0) (can use size)
  constraints: BoxConstraints(0.0<=w<=338.8, 0.0<=h<=44.8)
  size: Size(338.8, 44.8)
  direction: vertical
