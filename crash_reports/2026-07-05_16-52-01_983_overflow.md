---
type: overflow
created_at: 2026-07-05T16:52:01.983461
...
The specific RenderFlex in question is: RenderFlex#9df71 relayoutBoundary=up6 OVERFLOWING:
  parentData: offset=Offset(32.0, 32.0) (can use size)
  constraints: BoxConstraints(0.0<=w<=274.8, 0.0<=h<=217.5)
  size: Size(274.8, 217.5)
  direction: vertical
