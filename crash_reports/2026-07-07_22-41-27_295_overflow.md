---
type: overflow
created_at: 2026-07-07T22:41:27.295585
...
The specific RenderFlex in question is: RenderFlex#faf3d relayoutBoundary=up1 OVERFLOWING:
  parentData: offset=Offset(0.0, 0.0) (can use size)
  constraints: BoxConstraints(0.0<=w<=338.8, 0.0<=h<=26.1)
  size: Size(338.8, 26.1)
  direction: vertical
