---
type: overflow
created_at: 2026-07-07T20:19:26.855753
...
The specific RenderFlex in question is: RenderFlex#6074f relayoutBoundary=up2 OVERFLOWING:
  parentData: offset=Offset(32.0, 32.0) (can use size)
  constraints: BoxConstraints(0.0<=w<=274.8, 0.0<=h<=298.2)
  size: Size(274.8, 298.2)
  direction: vertical
