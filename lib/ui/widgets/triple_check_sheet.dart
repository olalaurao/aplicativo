...
Future<void> showTripleCheckSheet(
  ...
  await showModalBottomSheet<void>(
    ...
    builder: (_) => TripleCheckSheet(task: task),
  );
}
...
class TripleCheckSheet extends ConsumerStatefulWidget {
  ...
  const TripleCheckSheet({super.key, required this.task});
...
class _TripleCheckSheetState extends ConsumerState<TripleCheckSheet> {
  ...
  IconData _diagnosisIcon() {
    if (_head == null || _heart == null || _hand == null) return Icons.help_outline;
    final headBlocked = _head != TripleCheckAnswer.yes;
    final heartBlocked = _heart != TripleCheckAnswer.yes;
    final handBlocked = _hand != TripleCheckAnswer.yes;

    if (!headBlocked && !heartBlocked && !handBlocked) return Icons.check_circle_outline;
  ...
  Color _diagnosisColor() {
    if (_head == null || _heart == null || _hand == null) return AppColors.textMuted;
    final allGood = _head == TripleCheckAnswer.yes &&
      ...
      return [
        _ActionButton(
          ...
          onTap: () {
            ...
            // Open edit form for task — caller handles navigation
            _openEditTask();
          },
        ),
        _ActionButton(
  ...
  void _openEditTask() {
    // This navigates to edit — we push a route. Caller can override if needed.
    // For now we rely on the existing form infrastructure.
    Navigator.of(context).pop();
  }
              ...
              child: ListView(
                ...
                children: [
                  ...
                  if (isComplete) ...[
                    ...
                    if (_buildActionButtons().isNotEmpty) const SizedBox(height: 8),
                  ],
                  ...
                  SizedBox(
                    ...
                    child: ElevatedButton(
                      onPressed: isComplete ? _save : null,
                      ...
                      child: const Text('Salvar diagnóstico'),
                    ),
                  ),
